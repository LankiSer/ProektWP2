...
class WC_Edostavka_Shipping_Express_Stock_Door extends WC_Edostavka_Shipping {
	...
	public function __construct( $instance_id = 0 ) {
		$this->id           		= 'edostavka-express-stock-door';
		$this->method_title 		= 'Экспресс склад-дверь (СДЭК)';
