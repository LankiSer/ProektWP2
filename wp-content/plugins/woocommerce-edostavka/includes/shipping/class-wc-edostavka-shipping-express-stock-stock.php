...
class WC_Edostavka_Shipping_Express_Stock_Stock extends WC_Edostavka_Shipping {
	...
	public function __construct( $instance_id = 0 ) {
		$this->id           		= 'edostavka-express-stock-stock';
		$this->method_title 		= 'Экспресс склад-склад (СДЭК)';
