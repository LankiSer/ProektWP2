...
class WC_Edostavka_Shipping_Express_Stock_Postamat extends WC_Edostavka_Shipping {
	...
	public function __construct( $instance_id = 0 ) {
		$this->id           	= 'edostavka-express-stock-postamat';
		$this->method_title		= 'Экспресс склад-постамат (СДЭК)';
